    ...
    public class SolicitudDispersionController : Controller
    {
        ...
        private QuerySolicitud GenerarQueryGuardarSolicitud(ConexionSQL conexionSQL, SolicitudDispersion sd)
        {
            ...
            queries.Add($@"insert into arcigrm
                                ...
                                ('{sd.IdSucursal}', @idGrupo, '{sd.StrNombreCompleto}' , '1', '{sd.idPromotor}', '{sd.StrPromotor}', '{sd.DblMontoAutorizado}', '{sd.IntPlazo}', '1', '1', '{sd.StrFechaAlta}', '{sd.DblMontoSolicitado}', '{sd.StrUsuarioPromotor}', GETDATE(), '{sd.StrUsuarioPromotor}', GETDATE(), 'INDIVIDUAL', '{sd.StrFechaAlta}', '{sd.StrFechaAlta}')");
